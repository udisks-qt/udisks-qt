...
public Q_SLOTS:
    QDBusPendingReply<QDBusObjectPath> createPartition(qulonglong offset, qulonglong size, const QString &type, const QString &name, const QVariantMap &options = QVariantMap());
